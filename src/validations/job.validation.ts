...
export const getRecruiterJobsSchema = z.object({
  params: z.object({
    recruiterId: z
      .string()
      .regex(/^\d+$/, "Recruiter ID must be a valid number"),
  }),
});
...
export const jobResponseSchema = z.object({
  ...
  salary_min: z.bigint().nullable(),
  salary_max: z.bigint().nullable(),
  currency: z.string().nullable(),
  min_exp: z.bigint().nullable(),
  max_exp: z.bigint().nullable(),
  state_id: z.number().nullable(),
  city_id: z.number().nullable(),
  benefits: z.string().nullable(),
  openings_count: z.number().nullable(),
